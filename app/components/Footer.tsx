        ...
        {links.map(({ label, href, external, path }) => (
          <a
            ...
            {...(external
              ...
              : {})}
            className="group inline-flex items-center gap-2 text-body font-bold text-gray-700 hover:text-primary-600 transition-colors"
          >
            <svg
              viewBox="0 0 24 24"
              aria-hidden="true"
              className="size-4 shrink-0 fill-current transition-transform duration-200 group-hover:-translate-y-0.5"
            >
              <path d={path} />
            </svg>
